  ...
  return (
    <div className="main_contact">
        ...
        <div className="contact">
            ...
            <li><button className="buttons_in_contact" onClick={()=> window.open("https://www.linkedin.com/in/murali-aari-6b1046bb/", "_blank")}><img src="https://play-lh.googleusercontent.com/kMofEFLjobZy_bCuaiDogzBcUT-dz3BBbOrIEjJ-hqOabjK8ieuevGe6wlTD15QzOqw" alt="" /></button></li>
